...
from model.Multi_TAP.trainer.trainer import MultiTAPTrainer
...
def main():
    ...
    if args.source_domain:
        print("[Info] Frozen source-domain self-attention transform parameters.")
